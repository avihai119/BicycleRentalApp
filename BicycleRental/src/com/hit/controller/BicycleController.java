...
public class BicycleController {
    ...
    private Response<?> handleAddBicycle(JsonObject body) {  // Changed to Response<?>
        try {
    ...
    private Response<?> handleListAllBicycles() {  // Changed to Response<?>
        try {
    ...
    private Response<?> handleListAvailableBicycles() {  // Changed to Response<?>
        try {
    ...
    private Response<?> handleDeleteBicycle(JsonObject body) {  // Changed to Response<?>
        try {
            long bicycleId = body.get("bicycleId").getAsLong();
