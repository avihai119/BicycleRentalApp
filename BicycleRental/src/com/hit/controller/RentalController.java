...
public class RentalController {
    ...
    private Response<Bicycle> handleRentBicycle(JsonObject body) {
        try {
    ...
    private Response<String> handleReturnBicycle(JsonObject body) {
        try {
            long bicycleId = body.get("bicycleId").getAsLong();
    ...
    private Response<List<Rental>> handleGetActiveRentals() {
        try {
    ...
    private Response<List<Rental>> handleGetRentalHistory(JsonObject body) {
        try {
            if (body.has("userId")) {
                long userId = body.get("userId").getAsLong();
    ...
    private Response<Rental> handleSearchRental(JsonObject body) {
        try {
