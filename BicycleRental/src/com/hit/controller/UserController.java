...
public class UserController {
    ...
    private Response<?> handleAddUser(JsonObject body) {
        try {
    ...
    private Response<?> handleSearchUser(JsonObject body) {
        try {
    ...
    private Response<?> handleListAllUsers() {
        try {
    ...
    private Response<?> handleUpdateUser(JsonObject body) {
        try {
            long userId = body.get("userId").getAsLong();
    ...
    private Response<?> handleDeleteUser(JsonObject body) {
        try {
            long userId = body.get("userId").getAsLong();
    ...
    private Response<?> handleGetUserRentals(JsonObject body) {
        try {
            long userId = body.get("userId").getAsLong();
