...
public class UserController {
    ...
    private Response<?> handleAddUser(JsonObject body) {  // Changed to Response<?>
        try {
    ...
    private Response<?> handleSearchUser(JsonObject body) {  // Changed to Response<?>
        try {
    ...
    private Response<?> handleListAllUsers() {  // Changed to Response<?>
        try {
    ...
    private Response<?> handleUpdateUser(JsonObject body) {  // Changed to Response<?>
        try {
            long userId = body.get("userId").getAsLong();
    ...
    private Response<?> handleDeleteUser(JsonObject body) {  // Changed to Response<?>
        try {
            long userId = body.get("userId").getAsLong();
    ...
    private Response<?> handleGetUserRentals(JsonObject body) {  // Changed to Response<?>
        try {
            long userId = body.get("userId").getAsLong();
